...
def generate_plan(payload: WeeklyPlanRequest) -> WeeklyPlanResponse:
    ...
    return generate_weekly_plan(store.list_tasks(), payload.week_start, preferences, strategy=payload.strategy)
...
def replan(payload: ReplanRequest) -> WeeklyPlanResponse:
    ...
    previous_plan = generate_weekly_plan(current_tasks, payload.week_start, preferences)
